                    ...
                    if response:
                        ...
                        if inPuTMsG.strip().startswith('@a'):
                            ...
                            try:
                                ...
                                message = f'[B][C]{get_random_color()}\nACITVE Emote ALAMIN-> {xMsGFixinG(uid)}\n'
...
async def MaiiiinE():
    Uid , Pw = '4249831963','67B6EA9C226B933FA8F8331E650AF55E17CA938DB3BB6F831D988021AFC1706D'
    ...
    os.system('clear')
    print(render('LIKHON', colors=['white', 'green'], align='center'))
    print('')
